...
<html>
<script type="text/javascript" src="/ssmp/js/jquery-3.6.0.min.js"></script>
...
<form:form action="/ssmp/users" method="POST" modelAttribute="user" enctype="multipart/form-data">
    <c:if test="${user.id != null && user.id != 0}">
        <form:hidden path="id"/>
        <input type="hidden" name="_method" value="PUT"/>
    </c:if>
    <fmt:message key="user.head"></fmt:message>:<img style="width:200px" id="img" src="/ssmp/picturePreview?id=${user.id}"><input path="head" type="file" onchange="pictureImg(this)" name="picture"><br/>
