...
<br/>
<a href="/ssmp/users"><fmt:message key="add"></fmt:message></a>
...
<c:if test="${!empty requestScope.list }">
    <table border="1" cellpadding="10" cellspacing="0">
        ...
        <c:forEach items="${requestScope.list }" var="l">
            <tr>
                <th>${l.id}</th>
                <th><img src='/ssmp/picturePreview?id=${l.id}' width='40%'/></th>
                <th>${l.name}</th>
                <c:choose>
                ...
                <th>${l.birthdate}</th>
                <th>
                    <a class="delete" href="/ssmp/users/${l.id}"><fmt:message key="delete"></fmt:message></a>
                    <a href="/ssmp/users/${l.id}"><fmt:message key="update"></fmt:message></a>
                </th>
            </tr>
        </c:forEach>
    </table>
